...
public class CustomerDtoTwo {
	...
	private Integer refIndustryTypeId;
	...
	public void setRefStateId(Integer refStateId) {
		this.refStateId = refStateId;
	}

	public Integer getRefIndustryTypeId() {
		return refIndustryTypeId;
	}

	public void setRefIndustryTypeId(Integer refIndustryTypeId) {
		this.refIndustryTypeId = refIndustryTypeId;
	}
