...
public class EmployeeDto {
	...
	private Integer refEmpType;
	
	private Integer refContractorId;
	
	private Integer refShiftId;
	...
	public Integer getRefEmpType() {
		return refEmpType;
	}

	public void setRefEmpType(Integer refEmpType) {
		this.refEmpType = refEmpType;
	}
	...
	public Integer getRefShiftId() {
		return refShiftId;
	}

	public void setRefShiftId(Integer refShiftId) {
